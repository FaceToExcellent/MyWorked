...
- (void)viewDidLoad
{
    ...
    // 设置一排固定间距自动宽度子view
    [self setupAutoWidthViewsWithCount:3 margin:5];
...
- (void)setupCustomButton
{
    ...
    [_centerButton setImage:[UIImage imageNamed:@"11"] forState:UIControlStateNormal];
    _centerButton.titleLabel.backgroundColor = [UIColor greenColor];
